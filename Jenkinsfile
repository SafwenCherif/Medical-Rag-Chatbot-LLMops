                ...
                script {
                    ...
                    checkout scmGit(
                        ...
                        userRemoteConfigs: [[
                            ...
                            url: 'https://github.com/SafwenCherif/Medical-Rag-Chatbot-LLMops.git'
                        ]]
                    )
                }
            }
                ...
                withCredentials([[$class: 'AmazonWebServicesCredentialsBinding', credentialsId: 'aws-token']]) {
                    script {
                        ...
                        if [ -z "\$SERVICE_ARN" ] || [ "\$SERVICE_ARN" = "None" ]; then
                          echo "App Runner service '${SERVICE_NAME}' not found. Create it once in the AWS Console, then re-run."
                          exit 1
                        fi
